...
function BackgroundChanger() {
    ...
    return(
        <div className="absolute inset-3 rounded-4xl ring-1 ring-black/5 ring-inset shadow flex justify-center items-end" style={{ backgroundColor: background }}>
            <div className="rounded-4xl bg-zinc-100 dark:bg-gray-400 px-5 py-3 mb-3 shadow-lg">
                ...
                <button className="rounded-4xl text-white px-9 py-3 mr-2 cursor-pointer" style={{ backgroundColor: "black" }} onClick={() => setBackground('black')}>Black</button>
            </div>
        </div>
    )
}
